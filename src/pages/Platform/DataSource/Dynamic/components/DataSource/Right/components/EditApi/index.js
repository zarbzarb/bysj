...
import { getApiInfo, getSourceApiInfo, getAipInterfaceFilter } from '@/services/apis/dataManage';
...
function EditApi(props) {
  ...
  useEffect(() => {
    ...
    if (currentApi.id && !currentApi.configStatus) {
      Promise.all([
        getSourceApiInfo({
        ...
        // console.log(sourceApiInfo, apiInfo);
        if (!sourceApiInfo.success || !apiInfo.success || !sourceApiInfo.data) return;
        let {
