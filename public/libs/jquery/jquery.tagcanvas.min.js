...
(function (ap) {
  ...
  function Y(aJ, aI) {
    ...
    return (
      (j && j.getComputedStyle && j.getComputedStyle(aJ, null).getPropertyValue(aI)) ||
      (aJ.currentStyle && aJ.currentStyle[i])
    );
  }
  function u(j, aJ, aI) {
    var i = 1,
    ...
    if (aJ) {
      ...
      if ((aK = Y(j, 'font-size'))) {
        i =
          (aK.indexOf('px') > -1 && aK.replace('px', '') * 1) ||
          (aK.indexOf('pt') > -1 && aK.replace('pt', '') * 1.25) ||
          aK * 3.3;
      }
    }
    return i;
  ...
  function S(aK, aL) {
    var aJ,
      aI,
      i = parseInt(Y(aL, 'width')) / aL.width,
      ...
      if (aQ.outlineMethod == 'colour') {
        ...
        if (aQ.outlineMethod == 'size') {
          ...
          if (this.image) {
            aL.SetImage(
              this.image,
              this.iw + aQ.outlineIncrease,
              this.ih + aQ.outlineIncrease,
              aQ.imagePosition,
              aQ.imagePadding,
              aQ.imageAlign,
              aQ.imageVAlign,
  ...
  Q.Weight = function (aO) {
    var aK = aO.length,
      ...
      aL = [],
      j,
      aJ = this.weightFrom ? this.weightFrom.split(/[, ]/) : [null],
      aN = aJ.length;
    for (aI = 0; aI < aK; ++aI) {
      aL[aI] = [];
      for (aP = 0; aP < aN; ++aP) {
